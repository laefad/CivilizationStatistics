// see https://github.com/L3odr0id/civ-vi/tree/master/data
...
export type { MetaPlayer } from '@/types/metaPlayer'
export type { Nation } from '@/types/nation'
export type { Player, RatingChange } from '@/types/player'
